...
const Projects = () => {
  ...
  // Fallback if ProjectsContent is empty
  ...
  return (
    <div
      ref={containerRef}
      className="h-full pb-14 bg-indigo-400/50 flex flex-col justify-start w-full items-center"
      id="Projects"
    >
      <div className="flex p-10 gap-2 w-full items-center justify-center font-medium projects-title">
      ...
      <div className="w-[85%] h-full rounded-xl sm:py-10 py-4">
        <div className="flex flex-wrap w-full h-full justify-center items-center gap-4">
          {ProjectsContent.map((project, i) => {
            ...
            return (
              <div
                className="flex w-[20rem] sm:w-[40rem] justify-around items-center rounded-3xl"
                key={i}
              ...
              >
                <div className="flex flex-col text-center relative w-full">
                  ...
                  <h1 className="sm:text-3xl text-xl font-semibold w-[20rem] bg-yellow-500 p-1 sm:w-full rounded-b-xl">
                    {project.title}
                  </h1>
